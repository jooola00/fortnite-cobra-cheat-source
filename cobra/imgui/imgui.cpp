...
bool ImGui::SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags)
{
	...
	window->DrawList->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 10), ImVec2(frame_bb.Max.x, frame_bb.Min.y + 10), ImColor(20, 20, 20), 6);
	window->DrawList->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 10), ImVec2(grab_bb.Min.x, frame_bb.Min.y + 10), ImColor(255, 36, 36), 4);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad + 0.10f, pad + 0.10f), check_bb.Max - ImVec2(pad + 0.10f, pad + 0.10f), ImColor(47, 47, 47), 0);
	if (*v)
	{
		window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad + 0.10f, pad + 0.10f), check_bb.Max - ImVec2(pad + 0.10f, pad + 0.10f), ImColor(255, 36, 36), 0);
	}
