namespace Settings
{
	...
	bool Memory = true;
	bool Mouse = false;
	bool Silent = false; // working on it
	bool RenderFOV = true;
	...
	bool Weapon = false;
	bool Held = true;
	bool WorldDistance = true;
	bool Vehicles = true;

	static int tier; // 1 to 5
	...
	bool pSilent = false; //working on it

	float Range = 30000;

	bool OutlinedSkeleton = false;
	bool OutlinedESP = false;
	bool UpgradeBench = true;
